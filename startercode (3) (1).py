...
def wofFinalRound():
    ...
    for j in freeletters:
        ...
        buyVowel("e", winplayer)
    print(f"Here is your word to guess with the free letters:",blankWord)
    
    # finalguesses = []
    firstconsonant = guessletter(input("First consonant guess:"))
    secconsonant = guessletter(input("Second consonant guess:"))
    thirdconsonant = guessletter(input("Third consonant guess:"))
